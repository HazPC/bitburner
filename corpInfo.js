...
export const RESEARCH_DEFS = {
	...
	autoDrugs: { name: "Automatic Drug Administration", product: false, rank: 999 },
	bulkPurchasing: { name: "Bulk Purchasing", product: false, rank: 8 },
	cph4: { name: "CPH4 Injections", product: false, rank: 999 },
	...
	goJuice: { name: "Go-Juice", product: false, rank: 999 },
	hrRecruitment: { name: "HRBuddy-Recruitment", product: false, rank: 999 },
	hrTraining: { name: "HRBuddy-Training", product: false, rank: 999 },
	joywire: { name: "JoyWire", product: false, rank: 999 },
	marketta1: { name: "Market-TA.I", product: false, rank: 2 },
	marketta2: { name: "Market-TA.II", product: false, rank: 3 },
	overclock: { name: "Overclock", product: false, rank: 999 },
	scAssemblers: { name: "Self-Correcting Assemblers", product: false, rank: 999 },
	stimu: { name: "Sti.mu", product: false, rank: 999 },
	upgradeFulcrum: { name: "uPgrade: Fulcrum", product: true, rank: 4 },
	upgradeCapacity1: { name: "uPgrade: Capacity.I", product: true, rank: 5 },
	upgradeCapacity2: { name: "uPgrade: Capacity.II", product: true, rank: 6 },
	upgradeDashboard: { name: "uPgrade: Dashboard", product: true, rank: 7 }
};
